    ...
    public partial class RVOSystem : SystemBase
    {
        protected override void OnUpdate()
        {
            ...
            Entities
                ...
                .ForEach((LocalTransform translation, AgentComponent radius, VelocityComponent velocity, DynamicTreeElementComponent dynamicTree, ref VelocityObstacleComponent obstacle) =>
                {
            ...
            Entities
                ...
                .WithReadOnly(localToWorldLookup)
                .ForEach((LocalTransform translation, AgentComponent radius, DynamicTreeElementComponent agentTree, ObstacleTreeAgentComponent obstacleTree,
            ...
            Entities
                ...
                .WithReadOnly(velocityObstacleLookup)
                .WithReadOnly(localToWorldLookup)
                .ForEach((LocalTransform translation, AgentComponent radius, DynamicTreeElementComponent agentTree, RVOSettingsComponent agent,
