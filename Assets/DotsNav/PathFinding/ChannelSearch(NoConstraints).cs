...
//                 if (!false)
//                     Expand(next->Sym, float.MaxValue);

//                 next = step.Edge->LPrev->Sym;
//                 if (!false)
//                     Expand(next, float.MaxValue);
...
//                 {
//                     if (!false && !EndpointDisturbed(e, goal))
...
//             {
//                 if (false || edge->TriangleId == goalId && !validGoalEdges.Contains(edge->QuadEdgeId))
//                     return;
